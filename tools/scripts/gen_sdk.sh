...
function libs_cp()
{
	...
	if [ "$target_mcu" == "bk7231u" ]; then
		mkdir -p ${BEKEN_SDK_DIR}/driver/ble/ble_4_2
		cp ${BEKEN_LIB_DIR}/ble.a ${BEKEN_SDK_DIR}/driver/ble/ble_4_2/
	else
		mkdir -p ${BEKEN_SDK_DIR}/driver/ble/ble_5_1
		cp ${BEKEN_LIB_DIR}/ble.a ${BEKEN_SDK_DIR}/driver/ble/ble_5_1/
	fi
}
