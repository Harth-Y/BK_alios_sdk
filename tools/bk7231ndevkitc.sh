...
function files_cp()
{
	...
	if [ -f Living_SDK/platform/mcu/bk7231n/beken/driver/ble/ble_5_1/ble.a ]; then
	cp Living_SDK/platform/mcu/bk7231n/beken/driver/ble/ble_5_1/ble.a prebuild/lib/
	fi
	...
	cp Living_SDK/platform/mcu/bk7231n/beken/driver/ble/ble_5_1/ble_pub/app/api/app_ble_init.h prebuild/include
...
function build_bin()
{
	...
	cp Living_SDK/platform/mcu/bk7231n/bootloader_bk7231n_uart0_v1.0.13.bin $OUT/bootloader_bk7231n.bin
	$PYTHON tools/bk7231n/gen_firmware_img.py $OUT/$2@$3_crc.bin $OUT/bootloader_bk7231n.bin
